...
const ProfessionalSeeAllTheSlotes = () => {
  ...
  return (
    <>
      <div className="container-sm  w-50   m-auto">
        ...
        <form
          className="formm bg-white m-auto mb-2 mt-4  border border-warning border-3 rounded p-5 pb-2 pt-4"
          onSubmit={getAllSlotes}
        >
          <div className="form-group ">
            <h2 className="text-center fw-bold  mb-2">
              View Slots of Appointment
            </h2>
          </div>
...
export default ProfessionalSeeAllTheSlotes;
