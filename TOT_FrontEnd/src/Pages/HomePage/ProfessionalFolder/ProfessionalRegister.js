...
function ProfessionalRegister() {
  ...
  const [working_since, setworking_since] = useState(0);
  ...
  function checkForEmailAddress(event) {
    ...
    let url =
      "http://localhost:8080/professional/CheckForEmail/email?email=" + email;
    fetch(url)
      .then((response) => {
  ...
  function CreateProfessional(event) {
    ...
    console.log(JSON.stringify(working_since).substring(1, 11));
    ...
    fetch("http://localhost:8080/professional/addProfessional", requestOptions)
      .then()
  ...
  return (
    <>
      <div className="container-sm  formcover p-4  w-50   m-auto shadow  mb-5 mt-5 bg-white rounded">
        ...
        <form className="mt-4 " onSubmit={CreateProfessional}>
          <div className="row  ">
            <label>Name</label>
            <div className="col-lg-4">
              <input
                ...
                value={first_name}
                onChange={(e) => checkForName(e.target.value)}
              />
            </div>
            <div className="col-lg-4">
              <input
                ...
                onBlur={checkValidation}
                value={middle_name}
                onChange={(e) => checkForMiddleName(e.target.value)}
              />
            </div>
            <div className="col-lg-4">
              <input
                ...
                onBlur={checkValidation}
                value={last_name}
                onChange={(e) => checkForLastName(e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="row  mt-3 Address">
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                value={area}
                onChange={(e) => checkForArea(e.target.value)}
              />
            </div>
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                value={city}
                onChange={(e) => checkForCity(e.target.value)}
              />
            </div>
            ...
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                value={state}
                onChange={(e) => checkForState(e.target.value)}
              />
            </div>
          </div>
          <div className="row mt-2 Address2">
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                value={country}
                onChange={(e) => checkForCountry(e.target.value)}
              />
            </div>
            <div className="col-lg-4">
          ...
          <div className="row mb-4 mt-3">
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                value={password}
                onChange={(e) => checkForPassWord(e.target.value)}
              />
            ...
            <div className="col-lg-4">
              ...
              <input
                ...
                id="password"
                onBlur={checkValidation}
                onChange={(e) => checkForConfirmPassWord(e.target.value)}
              />
              <span style={{ fontWeight: "bold", color: "red" }}>
          ...
          <h1>
            <Link to={"/ProfessionalLogin"}>Go Back</Link>
          </h1>
        </form>
      </div>
    </>
