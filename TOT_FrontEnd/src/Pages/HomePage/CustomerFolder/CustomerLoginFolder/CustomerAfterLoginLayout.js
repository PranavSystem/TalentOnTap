...
import "../../ProfessionalFolder/ProfessionalLoginFolder/prolayout.css";
const CustomerAfterLoginLayout = () => {
  ...
  return (
    <>
      <h2 className="fw-bold text-center">
        {" "}
        Customer Id : {localStorage.getItem("Cid")}
      </h2>
      ...
      <div className="  row1-container">
        <div className="box bg-white box-down cyan">
          ...
          <Link to="/BookAppointmentByPinCode">
            <button type="button" className="mt-3 btn btn-info">
              Create
            </button>
          </Link>
          <img
        ...
        <div className="box bg-white box-down orange">
          ...
          <Link to="/UpdateSlotes">
            <button type="button" className="mt-3 btn btn-warning">
              View
            </button>
          </Link>
      ...
      <div className="row2-container">
        <div className="box bg-white red">
          ...
          <Link to="/DeleteSlot">
            <button type="button" className="mt-3 btn btn-danger">
              Update
            </button>
          </Link>
          <img
...
export default CustomerAfterLoginLayout;
