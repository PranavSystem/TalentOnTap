...
function RegisterCustomer() {
  ...
  function checkForEmailAddress(event) {
    ...
    let url =
      "http://localhost:8080/customer/checkForEmail/email?email=" + email;
    fetch(url)
      .then((response) => {
  ...
  const createNewCustomer = (event) => {
    ...
    fetch("http://localhost:8080/customer/addCustomer", requestOptions)
  ...
  return (
    <>
      <div className="container-sm  formcover p-4  w-50   m-auto shadow  mb-5 mt-5 bg-white rounded">
        ...
        <form className="mt-4 " onSubmit={createNewCustomer}>
          <div></div>
          <div className="row  ">
            <label>Name</label>
          ...
          <div className="row mt-2 Address2">
            <div className="col-lg-4">
              ...
              <input
                ...
                value={Address}
                onChange={(e) => {
                  checkForAddress(e.target.value);
                }}
              />
            </div>
            <div className="col-lg-4">
          ...
          <div className="row mb-4 mt-1">
            ...
            <div className="col-lg-4">
              ...
              <input
                ...
                onBlur={checkValidation}
                onChange={(e) => {
                  checkForConfirmPassWord(e.target.value);
                }}
              />
              <span style={{ fontWeight: "bold", color: "red" }}>
          ...
          <div className="text-center">
            ...
            ></input>
            <h3>
              <Link to={"/CustomerLogin"}>For Login Click Here</Link>
            </h3>
          </div>
        </form>
      </div>
